            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.button
                  ...
                  className="px-8 py-4 bg-white text-primary-600 rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-2"
                >
                  <LogIn size={20} />
                  <span>Connexion</span>
                </motion.button>
                <motion.button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-2"
                >
                  <UserPlus size={20} />
